...
const unsplashIds = [
	...
	"1611974714658-058f4c529944",
	"1450101499163-c8848c66ca85",
	"1554224155-6726b3ff858f",
	"1611095777215-ed39a7b97c8d",
	"1460925895917-afdab827c52f",
	"1579621970795-87f9aed197b1",
	"1580519542036-c47de6196ba5",
	"1590283603905-2465e9d9b433",
	"1610375461246-83df8dfb01d5",
	"1508921234172-73891048f766",
	"1517245386807-bb43f82c33c4",
	"1518186285589-2f7649de83e0",
	"1526628952-b2d10c47f27a",
	"1551288049-bbbda546697c",
	"1605792657660-596af9009e82",
	"1452378174528-3090a4bba7b2",
	"1543286386-713bdd5486d3",
	"1454165833767-027ffea9e77b",
	"1549421263-5ec394a5ad4c",
	"1526628953301-3e589a6a8b74",
	"1554224155-1696413575b9",
	"1579532566591-943b1e2ca493",
	"1590283603914-723bfca46917",
	"1512428559087-560fa5ceab42",
	"1550751827-4bd374c3f58b",
	"1502481851512-e9e2529bfbf9",
	"1518186285589-2f7649de83e0",
	"1524341517789-548773950fb2",
	"1534078362425-387b1c3e3906",
	"1550426743-f119e7cf9e46",
];
...
async function main() {
	...
	const files = [
		{
			path: join(rootDir, "_docs_backup/cat1_CFD기초.md"),
			type: "single",
			category: "CFD 기초",
		},
		{
			path: join(rootDir, "_docs_backup/cat6_카피트레이딩_가이드.md"),
			type: "single",
			category: "카피트레이딩",
		},
		{
			path: join(rootDir, "_docs_backup/cat8_사기예방_주의사항.md"),
			type: "single",
			category: "사기 예방",
		},
		{
			path: join(rootDir, "_docs_backup/cat2345_7_나머지콘텐츠.md"),
			type: "mixed",
		},
		{
			path: join(rootDir, "_docs_backup/교육컨텐츠_추가콘텐츠_완성.md"),
			type: "mixed",
		},
	];
	...
	for (const article of unique) {
		...
		console.log(
			`  ✅ [${article.sectionId}] ${article.category} - ${article.title}`,
		);
		count++;
	}
