...
const PATTERN_BODY_VISUALS = [
	{
		key: "장악형",
		path: "/images/patterns/bullish-engulfing.svg",
		alt: "상승 장악형 패턴",
	},
	{
		key: "하락 장악",
		path: "/images/patterns/bearish-engulfing.svg",
		alt: "하락 장악형 패턴",
	},
	{
		key: "돌파",
		path: "/images/patterns/breakout-up.svg",
		alt: "저항선 상향 돌파 시나리오",
	},
	{
		key: "캔들",
		path: "/images/patterns/candle-ohlc.svg",
		alt: "캔들 구조 분석",
	},
	{ key: "CFD", path: "/images/patterns/cfd.svg", alt: "CFD의 구조" },
	{
		key: "카피",
		path: "/images/patterns/copytrading.svg",
		alt: "카피트레이딩 알고리즘",
	},
	{ key: "도지", path: "/images/patterns/doji.svg", alt: "도지(Doji) 패턴" },
	{
		key: "자동",
		path: "/images/patterns/ea-logic.svg",
		alt: "EA 자동매매 로직",
	},
	{
		key: "피보나치",
		path: "/images/patterns/fibonacci.svg",
		alt: "피보나치 되돌림",
	},
	{
		key: "골드",
		path: "/images/patterns/gold-spec.svg",
		alt: "XAUUSD 골드 특성",
	},
	{
		key: "크로스",
		path: "/images/patterns/golden-cross.svg",
		alt: "골든크로스",
	},
	{ key: "망치", path: "/images/patterns/hammer.svg", alt: "망치형 패턴" },
	{
		key: "레버리지",
		path: "/images/patterns/leverage.svg",
		alt: "레버리지 원리",
	},
	{ key: "마진", path: "/images/patterns/margin.svg", alt: "마진 콜 기준" },
	{
		key: "샛별",
		path: "/images/patterns/morning-star.svg",
		alt: "샛별형 캔들",
	},
	{
		key: "리스크",
		path: "/images/patterns/risk-management.svg",
		alt: "리스크 관리 기법",
	},
	{
		key: "사기",
		path: "/images/patterns/scam-prevention.svg",
		alt: "스캠 방지책",
	},
	{
		key: "스프레드",
		path: "/images/patterns/spread.svg",
		alt: "스프레드 메커니즘",
	},
	{ key: "스탑", path: "/images/patterns/stoploss.svg", alt: "스탑로스 설정" },
	{
		key: "RSI",
		path: "/images/patterns/tech-analysis.svg",
		alt: "기술적 분석 지표",
	},
];
	...
	for (const line of lines) {
		...
		if (match) {
			...
			if (
				...
				(line.startsWith("---") && currentLines.length === 0)
			)
				continue;
...
async function deleteAllExisting(db) {
	...
	const q = query(
		collection(db, "treia_education"),
		where("app", "==", "treia"),
	);
	const snap = await getDocs(q);
	const delPromises = snap.docs.map((d) =>
		deleteDoc(doc(db, "treia_education", d.id)),
	);
