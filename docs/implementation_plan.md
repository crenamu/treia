...
- [x] **다이렉트 랜딩 시스템 고도화**: 구글 검색 대신 공식 가입 페이지로의 직결 매핑(`DIRECT_PRODUCT_URLS`) 체계 구축. (전북은행, 케이뱅크, HB저축은행 등 40/50 완료)
- [x] **404 네비게이션 오류 해결**: '/deposits' 등 잘못된 경로 수정 및 홈('/') 핸들링 최적화.
- [x] **신용카드 섹션 고도화**: 실물 카드 이미지 투입 및 카드사별 다이렉트 가입 링크 연동 완료.
