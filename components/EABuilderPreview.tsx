				...
				<div className="flex flex-col lg:flex-row items-center gap-12 relative z-10">
					...
					<div className="flex flex-col gap-6 lg:w-1/2">
						...
						<p className="text-gray-400 font-medium leading-relaxed text-lg max-w-lg">
							복잡한 MQL5 코딩은 트레이아가 대신합니다. 지표 노드를 드래그 앤
							드롭하여 전략을 짜고, AI 컨설턴트의 검증을 거쳐 즉시 실행 가능한
							봇을 만드세요.
						</p>
						...
						<div className="flex flex-wrap gap-4 mt-4">
							<Link
								href="/ea/builder"
								className="px-8 py-4 bg-amber-500 text-black font-black uppercase tracking-widest rounded-2xl hover:bg-white transition-all shadow-xl shadow-amber-500/10 flex items-center gap-2 group/btn"
							>
								빌더 시작하기{" "}
								<ChevronRight
									size={18}
