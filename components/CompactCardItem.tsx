    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-[11px] font-bold text-gray-400 truncate">{product.company}</span>
        </div>
      ...
      <div className="text-right shrink-0 px-4 border-l border-gray-50 ml-2 hidden sm:block">
        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">연회비</p>
        <p className="text-sm font-black text-gray-700">{product.annualFee}</p>
        <p className="text-[10px] font-bold text-gray-400 mt-0.5">{product.prevMonthRecord}</p>
      </div>
