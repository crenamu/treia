...
export default function AssetMetricCard({ title, value, trend, icon }: AssetMetricCardProps) {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-6">
        ...
        <div className={`text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full ${isNegative ? 'bg-red-50 text-red-500' : 'bg-green-50 text-green-500'}`}>
          {trend}
        </div>
      </div>
      <div>
