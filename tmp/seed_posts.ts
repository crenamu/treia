...
const samplePosts = [
  ...
  },
  {
    ...
    author: "열공트레이더",
    userId: "user_123",
    content: "현재 최고점 부근에서 다이버전스가 발생하는 것 같은데, 지금 진입해도 괜찮을까요? 차트 분석 잘하시는 분들 답변 부탁드립니다!",
    category: "질문/답변",
    likes: 2,
    comments: 8,
    timestamp: Timestamp.now(),
  ...
  },
  {
    ...
    author: "교육팀장",
    userId: "admin_edu",
    content: "지지와 저항은 트레이딩의 가장 기본입니다. 선을 긋는 것이 중요한 것이 아니라, 그 가격대에서 왜 매도/매수세가 붙었는지 이해하는 것이 핵심입니다.",
    category: "강의/교육",
    likes: 45,
    comments: 12,
    timestamp: Timestamp.now(),
