	...
	const products: CardProduct[] = [
		{
			...
			externalLink:
				"https://www.shinhancard.com/pconts/html/card/apply/credit/1188310_2207.html",
		},
		{
			id: "hyundai_m",
			name: "M Edition 3",
			...
			externalLink:
				"https://www.hyundaicard.com/cpc/cr/CPCCR0201_01.hc?cardWcd=M",
		},
		{
			id: "kb_daero",
			name: "다담카드",
			...
			externalLink:
				"https://card.kbcard.com/CRD/DVIEW/CPPC_STARDARD_CARD_DETAIL?mainCC=a&cardNm=다담카드",
		},
		{
			id: "samsung_id",
			name: "삼성 iD ON 카드",
			...
			externalLink:
				"https://www.samsungcard.com/home/card/cardinfo/doviewCardApp.do?mainCC=y&p_card_id=71243",
		},
		{
			id: "lotte_loca",
			name: "LOCA 365 카드",
			...
			tags: ["energy", "all"],
			externalLink:
				"https://www.lottecard.co.kr/app/LPCDADB_V100.lc?unon_id=14183",
		},
		{
			id: "hana_multi",
			name: "MULTI Any 카드",
			...
			tags: ["all", "shopping"],
			externalLink:
				"https://www.hanacard.co.kr/OPI41001M.web?schID=pcd&mID=OPI41001M&CD_WID=07026",
		},
	];
