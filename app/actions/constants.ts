...
export const BANK_LOGOS: Record<string, string> = {
	...BANK_LIST_TIER_1.reduce(
		(acc, bank) => ({ ...acc, [bank.name]: bank.logo }),
		{},
	),
	// 동적 로고 생성 (키워드 기반)
	...Object.entries(BANK_LOGO_MAP).reduce(
		(acc, [key, id]) => ({
			...acc,
...
export const DIRECT_PRODUCT_URLS: Record<string, string> = {
	// --- 예금 (Deposit) ---
	WR0001B:
		"https://spot.wooribank.com/pot/Dream?withyou=PRDEP0011&cc=c010528:c010531;c012425:c012425&PL_PRD_CD=P010002131&P_PRD_CD=P010002131", // 우리은행 WON플러스예금
	"10-011-137-0036":
		"https://obank.kbstar.com/quics?page=C016613&cc=b061496:b061645&prdcNm=KB%20Star%20%EC%A0%95%EA%B8%B0%EC%98%88%EA%B8%88", // KB국민은행 KB Star 정기예금
	...
	"10-011-133-0008":
		"https://nhlink.nonghyup.com/servlet/BFDCM1021R.view?WEB=Y&wrs_c=1000313840001&psnFncWrsC=10001160&listServiceId=BFDCM1013R", // NH농협 NH올원e예금
	"124": "https://www.suhyup-bank.com/ib20/mnu/FPD00008?PRODNO=124", // SH수협 헤이(Hey)정기예금
	"10511008000996000":
		"https://mbanking.imbank.co.kr/com_ebz_mbs_00001.act?svcId=fis_ebz_sbs_21030_depo&PD_CD=10511008000996000", // iM뱅크(대구) iM주거래예금
	"4": "https://www.kebhana.com/cont/mall/mall08/mall0801/mall080101/1479088_115126.jsp", // 하나은행 하나의정기예금
	"207-0134-16":
		"https://bank.shinhan.com/index.jsp?sns_type=fb&cr=020102010110&pcd=207013416", // 신한은행 신한My플러스 정기예금
	"207-0135-12":
		"https://m.shinhan.com/mw/fin/pg/PR0401S0000F01?mid=220011112006&pid=207013512&type=now", // 신한은행 쏠편한 정기예금
	"01211310142":
		"https://mybank.ibk.co.kr/uib/jsp/guest/ntr/ntr70/ntr7010/PNTR701000_i2.jsp?lncd=01&grcd=21&tmcd=131&pdcd=0130", // IBK기업은행 IBK굴리기통장
	"00320342":
		"https://www.standardchartered.co.kr/np/kr/pl/et/DepositDetail.jsp?id=639", // SC제일은행 e-그린세이브예금
	"10511008001166004":
		"https://mbanking.imbank.co.kr/com_ebz_mbs_00001.act?svcId=fis_ebz_sbs_21030_depo&PD_CD=10511008001166004", // iM뱅크 iM함께예금
	"01030500510002":
		"https://www.busanbank.co.kr/ib/v/p/FPD00008.do?PRODNO=01030500510002", // 부산은행 LIVE정기예금
	TD11300027000:
		"https://pbank.kjbank.com/ib20/mnu/FPD00008?PRODNO=TD11300027000", // 광주은행 미즈월복리정기예금
	"101272000006":
		"https://www.jejubank.co.kr/np/kr/pl/et/DepositDetail.jsp?id=101272000006", // 제주은행 제주Dream 정기예금
	...
	"10120114300011":
		"https://www.suhyup-bank.com/ib20/mnu/FPD00008?PRODNO=10120114300011", // 수협은행 Sh해양플라스틱Zero!예금
	...
	// --- 적금 (Savings) ---
	WR0001S:
		"https://spot.wooribank.com/pot/Dream?withyou=PRDEP0012&cc=c010528:c010531;c012425:c012425&PL_PRD_CD=P020002129", // 우리은행 WON적금
	WR0001L:
		"https://spot.wooribank.com/pot/Dream?withyou=PRDEP0012&cc=c010528:c010531;c012425:c012425&PL_PRD_CD=P020002129", // 우리은행 WON적금 (코드 보완)
	WR0001F:
		"https://spot.wooribank.com/pot/Dream?withyou=PRDEP0012&cc=c010528:c010531;c012425:c012425&PL_PRD_CD=P020002135", // 우리은행 우리SUPER주거래적금
	...
	"1001303001004":
		"https://www.tossbank.com/product-service/savings/savings-freedom", // 토스뱅크 자유 적금
	"1001303001001":
		"https://www.tossbank.com/product-service/savings/savings-growing", // 토스뱅크 키워봐요 적금
	...
	"230-0111-85":
		"https://bank.shinhan.com/index.jsp?sns_type=fb&cr=020102010110&pcd=230011185", // 신한은행 신한 알.쏠 적금
	"10521001001166004":
		"https://mbanking.imbank.co.kr/com_ebz_mbs_00001.act?svcId=fis_ebz_sbs_21030_depo&PD_CD=10521001001166004", // iM뱅크 iM함께적금
	"01020400490002":
		"https://www.busanbank.co.kr/ib/v/p/FPD00008.do?PRODNO=01020400490002", // 부산은행 펫 적금
	TD11330029000:
		"https://pbank.kjbank.com/ib20/mnu/FPD00008?PRODNO=TD11330029000", // 광주은행 해피라이프_여행스케치적금V
...
export function getSmartLandingUrl(
	bankName: string,
	productName: string,
	prdtCd?: string,
) {
