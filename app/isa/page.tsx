			...
			<main className="container mx-auto max-w-5xl px-6 py-12 md:py-20">
				...
				<div className="max-w-3xl mb-16 md:mb-24">
					...
					<p className="text-lg md:text-xl text-gray-500 font-medium leading-relaxed">
						이자부터 배송 소득까지 세금 혜택을 극대화하는 투자 필수 통장.
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
					{ISA_TYPES.map((type, idx) => (
						<div
							key={type.title}
							className="bg-white rounded-[32px] p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all"
						>
							<div
								className={`w-14 h-14 ${type.color} rounded-2xl flex items-center justify-center mb-6`}
							>
								{type.icon}
							</div>
				...
				<div className="bg-gray-900 rounded-[40px] p-8 md:p-16 text-white mb-20">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
						...
						<div className="bg-white/5 rounded-[32px] p-8 md:p-12 border border-white/10">
							...
							<button
								type="button"
								className="w-full mt-10 py-5 bg-blue-600 hover:bg-blue-700 text-white font-black text-sm uppercase tracking-widest rounded-2xl transition-all shadow-xl shadow-blue-500/20"
							>
								나에게 맞는 ISA 찾기
							</button>
						</div>
