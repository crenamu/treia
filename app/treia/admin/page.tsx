...
import { CheckCircle2, ChevronDown, Clock, Loader2, Mail, Send, XCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#050505] py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <header className="flex justify-between items-end mb-8 border-b border-[#222] pb-6">
          <div>
            <h1 className="text-3xl text-white font-light tracking-tight mb-2">Treia Leads Admin</h1>
            <p className="text-[#a1a1aa] text-sm">신청자 목록 및 이메일 발송 관리</p>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-[#111] border-b border-[#222]">
                    <th className="p-4 text-[#777] font-medium text-sm">Date</th>
                    <th className="p-4 text-[#777] font-medium text-sm">Name</th>
                    <th className="p-4 text-[#777] font-medium text-sm">Email</th>
                    <th className="p-4 text-[#777] font-medium text-sm">Reason / Inquiry</th>
                    <th className="p-4 text-[#777] font-medium text-sm text-center">Status</th>
                    <th className="p-4 text-[#777] font-medium text-sm text-center">Action</th>
                  </tr>
                </thead>
                    ...
                    return (
                      <tr key={lead.id} className="hover:bg-[#111]/50 transition">
                        ...
                        <td className="p-4 text-[#a1a1aa] font-mono text-sm flex items-center gap-2">
                          <Mail size={14} className="text-[#555]" /> {lead.contact}
                        </td>
