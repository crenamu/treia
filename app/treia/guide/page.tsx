	...
	return (
		<div className="min-h-screen bg-[#050505] text-[#f2f2f2] font-sans">
			...
			<main className="max-w-4xl mx-auto py-24 px-6 flex flex-col gap-24">
					...
					<div className="flex flex-col md:flex-row gap-12 items-center">
						...
						<div className="flex-1">
							<div className="flex items-center gap-4 mb-6">
								<div className="w-12 h-12 rounded-xl bg-[#111] border border-[#222] flex items-center justify-center text-[#c8a84b] font-mono text-xl">
									1
								</div>
							...
							<p className="text-[17px] text-[#a1a1aa] leading-[1.9] font-light mb-6 break-keep">
								...
								<strong className="text-white">`MetaTrader 5`</strong>를
								검색하여 설치해 주십시오.
				...
				{/* 화살표 구분선 */}
				<div className="flex justify-center text-[#222]">
					...
					<div className="flex flex-col md:flex-row-reverse gap-12 items-center">
						...
						<div className="flex-1">
							...
							<p className="text-[17px] text-[#a1a1aa] leading-[1.9] font-light break-keep">
								앱 실행 후{" "}
								<strong className="text-white">[설정] - [새 계좌]</strong> 추가
								버튼을 누른 뒤, 상단의 검색창에{" "}
								<strong className="text-white">&apos;Infinox&apos;</strong>를
								타이핑해 주십시오.
								<br />
								<br />
								목록에 나타나는{" "}
				...
				<section className="relative">
					<div className="flex flex-col md:flex-row gap-12 items-center">
						...
						<div className="flex-1">
							...
							<p className="text-[17px] text-[#a1a1aa] leading-[1.9] font-light mb-6 break-keep">
								미리 이메일로 받아두신{" "}
								<strong className="text-white">[로그인 ID]</strong>와{" "}
								<strong className="text-[#c8a84b]">[관전자 비밀번호]</strong>를{" "}
								<strong className="text-white underline underline-offset-4 decoration-[#444]">
									대소문자 구분
								</strong>
								하여 정확히 입력하십시오.
								<br />
				...
				<section className="mt-12 pt-16 border-t border-[#111]">
					<div className="bg-[#0a0a0e] border border-[#1a1a1a] rounded-3xl p-8 md:p-12 text-center max-w-3xl mx-auto">
						...
						<p className="text-[16px] text-[#a1a1aa] leading-[1.8] font-light break-keep">
							하단 메뉴에 위치한{" "}
							<strong className="text-white border-b border-[#333] pb-0.5">
								[거래]
							</strong>{" "}
			...
			<footer className="py-12 border-t border-[#111] text-center">
				<p className="text-[#444] text-[12px] uppercase tracking-widest">
