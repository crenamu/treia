		...
		<div className="min-h-screen bg-[var(--bg-beige)] py-12 pb-32">
			<div className="container mx-auto max-w-5xl px-6">
				...
				<div className="flex items-center justify-between mb-12">
					<button
						onClick={() => router.back()}
						className="flex items-center gap-2 text-gray-500 hover:text-gray-900 font-bold group"
					>
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
					...
					<div className="lg:col-span-2 space-y-8">
						...
						<div className="bg-white rounded-[48px] p-10 md:p-12 shadow-sm border border-gray-100 relative overflow-hidden">
							...
							<div className="flex items-center gap-3 mb-6">
								<span
									className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest text-white ${notice.status === "접수중" ? "bg-blue-600" : "bg-gray-400"}`}
								>
									{notice.status}
								</span>
							...
							<div className="space-y-10">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
									<div className="space-y-4">
										...
										<p className="text-xs text-gray-500 leading-relaxed font-medium">
											과거 유사 공고의 커트라인과 현재 유입 데이터를 기반으로
											산출된 예상 점수입니다.
										</p>
									</div>
									<div className="space-y-4">
										...
										<div className="flex items-baseline gap-2">
											<span className="text-5xl font-outfit font-black text-green-400">
												35
											</span>
										...
										<p className="text-xs text-gray-500 leading-relaxed font-medium">
											반경 1km 이내 유사 평형 아파트 전세가 평균 대비 실질 혜택
											비율입니다.
										</p>
									</div>
								</div>
								...
								<div className="p-6 bg-white/5 rounded-3xl border border-white/10">
									...
									<p className="text-sm text-gray-400 leading-relaxed font-medium italic">
										&quot;본 공고는 {notice.location} 지역의 핵심 인프라를 누릴
										수 있는 최적의 기회입니다. 특히 일반 공급 대비 우대 대상
										조건이 완화되어 있어, 청년/신혼부부 계층의 전략적 지원 시
										당첨 가능성이 매우 높을 것으로 분석됩니다.&quot;
									</p>
								</div>
							</div>
						</div>
						...
						<div className="bg-white rounded-[48px] p-10 md:p-12 shadow-sm border border-gray-100 space-y-12">
							<DetailSection
								...
								content={
									notice.description ||
									"이 공고는 LH와 SH의 통합 정보를 기반으로 FinTable AI가 재구성한 내용입니다. 실제 신청 시 모집공고문을 반드시 확인하시기 바랍니다."
								}
							/>
					...
					<div className="space-y-8">
						<div className="bg-blue-600 rounded-[48px] p-8 text-white shadow-2xl shadow-blue-500/20 sticky top-24">
							...
							<div className="text-6xl font-outfit font-black text-white mb-4">
								{prob}%
							</div>
							<p className="text-[10px] text-blue-200 font-bold mb-10 leading-relaxed">
								* 진단 도구를 통한 고객님의 정보를 바탕으로 AI가 계산한
								수치입니다.
							</p>
						...
						<div className="bg-white rounded-[40px] p-8 border border-gray-100 shadow-sm text-center">
							<p className="text-[10px] text-gray-400 font-black uppercase tracking-widest mb-6">
								Related Bridge Strategy
							</p>
							<div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-600 mx-auto mb-6">
								<Rocket size={28} />
							</div>
							<h4 className="text-lg font-black text-gray-900 mb-3 tracking-tight">
								청약 브릿지 상품
							</h4>
							<p className="text-xs text-gray-500 font-medium mb-8 leading-relaxed">
								본 공고 당첨 시 보증금 마련을 돕는
								<br />
								최적의 금융 상품을 확인하세요.
							</p>
							<Link
								href="/savings"
								className="text-xs font-black text-blue-600 uppercase tracking-widest flex items-center justify-center gap-2 hover:gap-4 transition-all"
							>
...
function TipCard({
	...
	return (
		<div className="p-6 bg-gray-50 rounded-[32px] border border-gray-100 flex flex-col items-center text-center gap-3 hover:bg-white hover:shadow-xl transition-all duration-500">
			<div className="p-3 bg-white rounded-2xl text-blue-600 shadow-sm border border-gray-100">
				{icon}
			</div>
			<div>
