...
export const metadata: Metadata = {
  ...
  description:
    "Experience the future of trading with AI-driven insights and tick data analysis.",
};
          ...
          <footer className="border-t border-[var(--border-color)] bg-[#0F1115] py-16">
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
              <div className="col-span-1 md:col-span-2 flex flex-col gap-6">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-xl font-outfit font-black text-white tracking-tighter uppercase italic">
                    Treia
                  </span>
                </div>
                <p className="text-sm text-[var(--text-secondary)] max-w-sm leading-relaxed font-medium">
                  데이터 기반 분석과 AI 기술이 결합된 교육용 트레이딩 인사이트
                  플랫폼입니다.
                </p>
              </div>
              <FooterLinks
            ...
            <div className="container mx-auto px-6 mt-16 pt-8 border-t border-gray-900 text-center">
              <p className="text-[10px] text-gray-600 mb-4 px-4 leading-relaxed font-medium uppercase tracking-widest">
                ⚠️ 본 서비스는 교육 및 정보 제공만을 목적으로 하며, 실제 투자
                권유나 금전적 수익을 보장하지 않습니다. 모든 투자의 판단과
                책임은 투자자 본인에게 있습니다.
              </p>
              <p className="text-[10px] text-gray-700 font-bold tracking-widest uppercase">
                © 2026 Treia. All rights reserved.
              </p>
            </div>
          </footer>
          <GlobalAuthModal />
