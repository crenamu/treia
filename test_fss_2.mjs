    ...
    for (const grp of grps) {
        ...
        try {
            ...
            if (baseCount > 0) {
                ...
                const matchingOptions = data.result.optionList.filter(o => o.fin_prdt_cd === firstBase.fin_prdt_cd);
                console.log(`First Product: ${firstBase.fin_prdt_nm}, Matching Options: ${matchingOptions.length}`);
            }
        } catch (e) {
